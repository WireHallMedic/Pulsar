...
public class HelpPanel extends RogueTilePanel implements GUIConstants, WSFontConstants, KeyListener
{
   ...
   public String[][] getPages()
   {
      String[] pageOne = {
         ...
         "  A      [A]ttack; press again to confirm target",
         "  S      [S]witch weapons",
         "  G      [G]rab an item off the ground",
         "  U      [U]se; you will be prompted for a target",
         " 1-5     Use gadget",
         "  L      [L]ook mode",
         "  C      Open [c]haracter panel",
         "  H      Open [h]elp panel (the one you're looking at)",
         "Escape   Cancel",
         "Enter    Confirm",
         "Space    Confirm",
         "",
