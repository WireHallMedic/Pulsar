...
public interface GUIConstants
{
   ...
   public static final double SLOW_MOVE_SPEED = .05 * 1.5;
   public static final double NORMAL_MOVE_SPEED = .2 * 1.5;
   public static final double FAST_MOVE_SPEED = .3 * 1.5;
   public static final int MELEE_ATTACK_HIT_DELAY = 9;
   public static final double SPRAY_BASE_SPEED = .3 * 1.5;
   public static final double SPRAY_VARIABLE_SPEED = .05 * 1.5;
